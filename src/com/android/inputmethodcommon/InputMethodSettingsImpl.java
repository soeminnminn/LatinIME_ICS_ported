...
/* package private */ class InputMethodSettingsImpl implements InputMethodSettingsInterface {
    ...
    public boolean init(final Context context, final PreferenceScreen prefScreen) {
        ...
        try {
        	...
        	Log.e("InputMethodSettingsImpl", nsme.toString());
        	//return false; // SMM
        }
                ...
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        try {
                        	...
                        	Log.e("InputMethodSettingsImpl", anfe.toString());
                        }
                        // SMM {
                        final Intent intent = new Intent(preference.getContext(), SubTypeSettingsActivity.class);
                        intent.putExtra(Settings.EXTRA_INPUT_METHOD_ID, mImi.getId());
                        if (!TextUtils.isEmpty(title)) {
                            intent.putExtra(Intent.EXTRA_TITLE, title);
                        }
